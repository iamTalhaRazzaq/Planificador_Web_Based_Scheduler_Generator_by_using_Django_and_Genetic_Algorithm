...
class Class:
    ...
    def get_students(self): return self.student
    ...
    #student_data
    def set_student(self, student): self.student = student
...
def about(request):
    data_1={
        'title':'About Us',
        'about_title':'About Planficador Scheduler'
    }
    return render(request, 'aboutus.html', data_1)
...
def help(request):
    ...
    return render(request, 'help.html', data_1)
...
def delete_student(request, pk):
    STU = studnts.objects.filter(pk=pk)
    if request.method == 'POST':
        STU.delete()
