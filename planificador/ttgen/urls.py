...
urlpatterns = [
    ...
    path('add_students', views.addStudents, name='addStudents'),
    path('student_list/', views.stu_list_view , name='editstudents'),
    path('delete_student/<int:pk>/', views.delete_student, name='deletestudents'),
